...
if(aluno1.notas>=60){aluno1si=true;totalaprovados=totalaprovados++}
    let aluno2={ nome: prompt("dijite o nome") ,notas:Number(prompt("dijite a nota total"))}
if(aluno2.notas>=60){aluno2si=true;totalaprovados=totalaprovados++}
    let aluno3={ nome: prompt("dijite o nome") ,notas:Number(prompt("dijite a nota total"))}
if(aluno3.notas>=60){aluno3si=true;totalaprovados=totalaprovados++}
    let aluno4={ nome: prompt("dijite o nome") ,notas:Number(prompt("dijite a nota total"))}
if(aluno4.notas>=60){aluno4si=true;totalaprovados=totalaprovados++}
